...
const FailedTask = ({ data }) => {
  return (
    <div className="shrink-0 w-[320px] p-6 bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 bg-rose-500/10 hover:bg-rose-500/[0.15] transition-all duration-300">
