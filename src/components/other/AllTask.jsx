  ...
  return (
    <div className="mt-8 mb-10">
      <div className="bg-[#111111]/60 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-emerald-500/10 shadow-2xl relative overflow-hidden group">
        <div className="mb-8 items-end justify-between hidden sm:flex">
          <div>
        ...
        <div className="space-y-3 custom-scrollbar overflow-auto max-h-[400px] pr-2">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 group-hover/row:bg-emerald-500/20 transition-all">
